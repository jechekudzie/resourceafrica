...
Route::get('/administration/users/{id}/{type}', [App\Http\Controllers\API\ApiController::class, 'fetchOrganizationUsers']);
...
Route::post('/administration/fields/delete', [App\Http\Controllers\API\ApiController::class, 'deleteField']);
Route::post('/administration/fields/update', [App\Http\Controllers\API\ApiController::class, 'updateField']);
Route::post('/administration/field/options', [App\Http\Controllers\API\ApiController::class, 'updateFieldOptions']);
Route::post('/administration/register-user', [App\Http\Controllers\API\ApiController::class, 'registerNewUser']);
