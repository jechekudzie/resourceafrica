                                ...
                                <div class="intro-y flex flex-col-reverse sm:flex-row items-center">
                                    <div class="w-full sm:w-auto flex">
                                        <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#basic-modal-preview"
                                           class="btn btn-primary">Add HWC Types</a>
                                    </div>
                                </div>
                                <!-- END: Inbox Filter -->
                            </div>
                            ...
                            <table id="example" class="table-bordered min-w-full divide-y divide-gray-200">
                               ...
                               @foreach($types as $types)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">{{$types->name}}</td>
                                    <td class="px-6 py-4 whitespace-nowrap">{{$types->description}}</td>
                        ...
                        <div id="basic-modal-preview" class="modal" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form method="post" action="{{ url('/administration/hwc/types') }}">
                                        @csrf
                                        <div class="intro-y col-span-12 lg:col-span-6">
                                            <!-- BEGIN: Form Layout -->
                                            <div class="intro-y box p-5">
                                                <div>
                                                    <label for="crud-form-1" class="form-label">HWC Type</label>
                                                    <input id="crud-form-1" type="text" class="form-control w-full"
                                                           placeholder="Enter new hwc type" name="name">
                                                </div>

                                                <div class="mt-3">
                                                    <label for="crud-form-1" class="form-label">HWC Type Description</label>
                                                    <textarea id="crud-form-1" class="form-control w-full"
                                                              placeholder="Enter HWC Type description"
